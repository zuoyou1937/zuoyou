...
public class Bitmap_to_string {
    ...
    public String Bitmap_to_string(Bitmap bitmap){
        ...
        mTess.init(Environment.getExternalStorageDirectory().getAbsolutePath()+"/tesseract","eng");//初始化
     ...
     * 将assets中的识别库复制到SD卡中
     *
     * @param path 要存放在SD卡中的 完整的文件名。这里是"/mnt/sdcard/tesseract/tessdata/eng.traineddata"
     * @param name assets中的文件名 这里是 "eng.traineddata"
     */
    public void assets2SD(Context context, String path, String name) {
        //如果存在就删掉
